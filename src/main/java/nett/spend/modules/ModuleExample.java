package nett.spend.modules;

import nett.spend.Nett;
...
public class ModuleExample extends Module {
    ...
    public ModuleExample() {
        super(Nett.CATEGORY, "world-origin", "An example module that highlights the center of the world.");
    }

    /**
     * Example event handling method.
     * Requires {@link Nett#getPackage()} to be setup correctly, will fail silently otherwise.
     */
    @EventHandler
